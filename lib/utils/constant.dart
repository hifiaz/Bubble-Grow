...
const Map<String, Rule> kRules = {
  ...
  'NC':
      Rule(number: true, color: true), // multiples of N that are of same colour
  'TC': Rule(timer: true, color: true), // same colour but within timer
  'TN': Rule(timer: true, number: true), // multiples of N but within timer
  'TNC': Rule(
      timer: true,
      number: true,
      color: true), // multiples of N that are of same colour but within timer
};

String pathImage(String name) {
  if (name == 'Blues') {
